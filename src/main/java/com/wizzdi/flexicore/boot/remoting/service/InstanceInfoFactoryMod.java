 ...
 * @author Spencer Gibb
 */
public class InstanceInfoFactoryMod {

	private static final Log log = LogFactory.getLog(InstanceInfoFactoryMod.class);

	public InstanceInfo.Builder create(EurekaInstanceConfig config) {
		...
		builder.setLeaseInfo(leaseInfoBuilder.build());
		return builder;
	}
